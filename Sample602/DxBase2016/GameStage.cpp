...
namespace basedx11{
	...
	void GameStage::CreateBox(){
		auto BoxPtr = AddGameObject<Box>(Vector3(0.5f, 0.5f, 2.0f), Vector3(-2.0f, 0.25f, 0));
		//シェア配列にBoxを追加
		SetSharedGameObject(L"Box", BoxPtr);
	}

	//動く球体の作成
	void GameStage::CreateMoveSphere(){
		AddGameObject<MoveSphere>(Vector3(0.5f, 0.5f, 0.5f), Vector3(2.0f, 0.25f, 0));
