...
namespace basedx11{
	...
	void GameStage::CreateMoveObject(){
		AddGameObjectWithParam<MoveObject>(Vector3(-8.0f, 0.5, 0), Vector3(7.0f, 0.0, 7.0f), true);
		AddGameObjectWithParam<MoveObject>(Vector3(0.0f, 0.5, 0), Vector3(-5.0f, 0.0, 6.0f), false);
		AddGameObjectWithParam<MoveObject>(Vector3(8.0f, 0.5, 0), Vector3(-7.0f, 0.0, 6.0f), true);
		AddGameObjectWithParam<MoveObject>(Vector3(0.0f, 0.5, 2.0f), Vector3(6.0f, 0.0, 5.0f), false);
	}
